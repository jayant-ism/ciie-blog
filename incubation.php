...
<head>
    ...
    <title>Incubation in IIT ISM</title>
...
<!--    
    <div class="fixed-action-btn"  style="right: 50px; bottom: 50px;">
        ...
        <ul>
          ...
          <li><a class="btn-floating" href="#about"  style="border-radius: 0%; width: 100px; background-color: #116466;">About us</a></li>
          <li><a class="btn-floating" href="#incubation" style="border-radius: 0%; width: 100px; background-color: #116466;">Incubation Process</a></li>
          <li><a class="btn-floating" href="#support" style="border-radius: 0%; width: 100px; background-color: #116466;">Support offered </a></li>
          <li><a class="btn-floating" href="#rules" style="border-radius: 0%; width: 100px; background-color: #116466;">Rules and regulations </a></li>
          <li><a class="btn-floating"  href="#terms" style="border-radius: 0%; width: 100px; background-color: #116466;;">Terms and Conditions</a></li>
          <li><a class="btn-floating" href="#application" style="border-radius: 0%; width: 100px; background-color: #116466;;">Applications</a></li>
